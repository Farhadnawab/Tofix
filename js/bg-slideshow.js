...
var slideOffset = 0;
var groupId = 0;
var timeSlider = 3500; //3500 à la base
var timeGlide = 700;
var timeOpacity = 200;
    ...
    $(grid).animate({  fake: slideOffset }, {
        ...
        complete: function(){
            ...
            for (let i = 0; i < batchTotal; i++) {
                group.push($(groups.item(i)));
                clonedGroup.push(group[i].clone());
            }
            //console.log($(".grid .grid-item").length);
            setTimeout(function() {
                    ...
                    setTimeout(function(){
                        e.animate({fake: 1000 }, {
                            ...
                            complete: function(){
                                ...
                                if(clonedGroup[idx].find(".video-elem").length > 0){
                                    initializeVideo(clonedGroup[idx].find(".video-elem"));
                                }
